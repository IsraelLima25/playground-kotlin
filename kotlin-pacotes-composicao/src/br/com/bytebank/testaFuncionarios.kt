...
fun testaFuncionarios() {
    ...
    if (gerente.autentica(1234)) {
        println("br.com.bytebank.br.com.bytebank.modelo.Gerente autenticado")
        gerente.bonificacao()
    }
    ...
    if (diretor.autentica(5555)) {
        println("br.com.bytebank.br.com.bytebank.modelo.Diretor autenticado")
    }

    println("br.com.bytebank.br.com.bytebank.modelo.Gerente")
    println("------------------------------------")
    ...
    println("br.com.bytebank.br.com.bytebank.modelo.Diretor")
    println("------------------------------------")
